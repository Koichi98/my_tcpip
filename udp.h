...
extern int udp_endpoint_pton(char *p, struct udp_endpoint *n);
extern char* udp_endpoint_ntop(struct udp_endpoint *n, char *p, size_t size);

extern ssize_t udp_output(struct udp_endpoint *src, struct udp_endpoint *dst, const uint8_t *buf, size_t len);

extern int udp_open(int non_blocking);
